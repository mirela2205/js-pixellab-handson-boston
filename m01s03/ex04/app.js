...
console.warn(`Afiseaza diferenta dintre lungimea arrayului si valoarea din pozitia 5.
`);
...
console.warn(`Folosind metoda Math.pow() afla rezultatul ridicarii la putere a numarului de pe pozitia 5 la numarul de pe pozitia 3
`);
